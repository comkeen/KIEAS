...
//		System.out.println("Using GoogleCapLibrary : \n" + result2);
	...
	public void FullCapBuildTest()
	{
		...
		//Info 요소 작성
		//setInfoElement(int infoIndex, String value)
		...
		//Resource 요소 작성
		//setResourceElement(int infoIndex, int resourceIndex, String value)
		kieasMessageBuilder.setResourceDesc(0, 0, "Resource Description");
		kieasMessageBuilder.setMimeType(0, 0, "Mime Type");

		//Area 요소 작성
		//setAreaElement(int infoIndex, int areaIndex, String value)
