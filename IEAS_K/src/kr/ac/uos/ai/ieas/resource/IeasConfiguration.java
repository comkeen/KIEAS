...
//		public final static String ACTIVEMQ_SERVER_IP = "tcp://172.16.165.173:61616"; //vm window
	...
	public static class IEAS_List {
		...
		public final static String[] ALERT_SYSTEM_TYPE_LIST = {
			"자동우량경보시스템",
			"자동음성통보시스템",
			"DMB재난경보방송시스템",
			"RDS시스템",
		...
		public final static String[] LOCATION_LIST = {
			"Seoul",
			"Deagu",
			"Busan",
			"Jeju"
		...
		public final static String[] EVENT_LIST = {
			"호우 경보",
			"대설 경보",
			"강풍 경보"
		};
		
		public final static String[] EVENT_CODE_LIST = {
			"HRW",
			"HAS",
			"HWW"
		};
