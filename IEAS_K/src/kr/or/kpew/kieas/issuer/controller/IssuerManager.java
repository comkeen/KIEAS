...
public class IssuerManager
{
	 ...
	 */
	public IssuerManager(ITransmitter transmitter, IssuerProfile profile)
	{
		init(transmitter, profile);
	}
	
	public void init(ITransmitter transmitter, IssuerProfile profile)
	{
